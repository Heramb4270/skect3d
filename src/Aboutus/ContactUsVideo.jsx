...
const AboutusVideo = () => {
  ...
  const textData = [
    { text: "Sketchers 3D specializing in", duration: 7000 },
    ...
    const fetchVideoURL = async () => {
      try {
        const gsReference = ref(
          storage,
          "gs://deo-project-201f2.appspot.com/videos/SKETCH-VILLA -EXPORT.mp4"
        );
  ...
  return (
    <div className="relative h-screen">
      ...
      <div
        id="text-overlay"
        className="absolute inset-0 flex items-center justify-center text-white z-10 opacity-0 transition-opacity duration-1000 text-6xl font-bold"
      ></div>
    </div>
  );
};
