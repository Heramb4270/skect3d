...
// import interiorlogo from '../images/interior-design.png';
// import exteriorlogo from '../images/citytech-logo.png';
// import vr from '../images/virtual-reality.png'
...
const Urbano = ({ heading, architect, projectBy, backgroundImage }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative bg-black">
              ...
              <div className="flex justify-center space-x-4 mt-4">
                ...
                <div className="relative inline-block font-medium group py-1.5 px-2.5">
                  <img
                    ...
                    onClick={() => navigateToPage("urbanoInterior")}
                  />
                ...
                <div className="relative inline-block font-medium group py-1.5 px-2.5">
                  <img
                    ...
                    alt="exterior"
                    className="h-16 w-16 mr-4 transition-transform transform hover:scale-110"
                    onClick={() => navigateToPage("urbanoexterior")}
                  />
      ...
      {showVideoPopup && (
        <VideoPopup videoId="F0Lbv9DofNA" onClose={closeVideoPopup} />
      )}
    </div>
  );
};
